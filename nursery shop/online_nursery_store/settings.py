"""
Django settings for online_nursery_store project.
...
ROOT_URLCONF = 'online_nursery_store.urls'
...
WSGI_APPLICATION = 'online_nursery_store.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'final',          # Replace with your database name
